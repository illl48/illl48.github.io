...
/***/ function(module, exports, __webpack_require__) {
	...
	var Membership = __webpack_require__(238);

	module.exports = { App: App, Home: Home, SocialClubs: SocialClubs, Events: Events, Membership: Membership };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SocialClubs = function (_React$Component) {
	  ...
	  function SocialClubs(props) {
	    ...
	    _this.state = { members: [{ order: 0, link: 'http://www.sbcwa.org/JESSIE-2015.png' }, { order: 1, link: 'http://www.sbcwa.org/JULIA-2015.png' }, { order: 2, link: 'http://www.sbcwa.org/BETTY-2015.png' }, { order: 3, link: 'http://www.sbcwa.org/STEPHANIE-2015.png' }, { order: 4, link: 'http://www.sbcwa.org/LOUISE-2015.png' }] };
	    return _this;
	  }
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          ' SBCWA 2015 CHAIRWOMAN AND DIRECTORS '
	        ),
	        React.createElement(
	          'div',
	          { className: 'memberList' },
	          this.state.members.map(this.showMember)
	        )
	      );
	    }
	  }]);
	  ...
	  _createClass(Events, [{
	    ...
	    value: function showEvent(event) {
	      ...
	      for (var i = 0; i < event.imgs.length; i++) {
	        imgdisplay.push(React.createElement(
	          'div',
	          { key: i },
	          React.createElement('img', { src: event.imgs[i] })
	        ));
	      }

	      return React.createElement(
	        'div',
	        { key: event.title, className: 'eachEvent' },
	        React.createElement(
	          'div',
