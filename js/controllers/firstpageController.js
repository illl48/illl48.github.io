app.controller('firstpageController', ['$scope','$http', function($scope,$http) {
    ...
    $scope.send=function(){
        ...
        $http.get("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522,151.1957362&radius=500&types=food&name=cruise&key=AIzaSyAMOszNOH-Bf1QX68qGtSD_9QGmJDLlP1g")
